...
namespace App.Utility
{
	public abstract class CommonAudioMixerController<TEnum> where TEnum : Enum
	{
		...
		public static float ConvertVolumeToDecibel(float value) => Mathf.Log10(value) * DECIBEL_MULTIPLIER;
		public static float ConvertDecibelToVolume(float decibel) => Mathf.Pow(10f, decibel / DECIBEL_MULTIPLIER);
